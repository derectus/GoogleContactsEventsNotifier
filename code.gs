...
var i18n = {
  ...
  'tr': {
    ...
    'Years': 'Yıllar',
    'Events': 'Etkinlikler',
    'Birthdays today': 'Doğum günü',
    'Birthdays tomorrow': 'Yarın olan doğum günleri',
    'Birthdays in {0} days': '{0} gün içindeki doğum günleri',
    'Anniversaries today': 'Bugün olan yıl dönümleri',
    'Anniversaries tomorrow': 'Yarın olan yıl dönümleri',
    'Anniversaries in {0} days': '{0} gün içindeki doğum günleri',
    'Custom events today': 'Bugün olan kişisel etkinlikler',
    'Custom events tomorrow': 'Yarın olan kişisel etkinlikler',
    'Custom events in {0} days': '{0} gün içindeki kişisel etkinlikler',
    'Hey! Don\'t forget these events': 'Heyy ! Bu etkinlikleri unutma.',
    'version': 'versiyon',
    'dd-MM-yyyy': 'dd-MM-yyyy',
    'Mobile phone': 'Cep telefonu',
    'Work phone': 'İş telefonu',
    'Home phone': 'Ev telefonu',
    'Main phone': 'Sabit telefon',
    'Other phone': 'Diğer Telefon numarası',
    'Home fax': 'Ev fax numarası',
    'Work fax': 'İş fax numarası',
    'Google voice': 'Google voice',
    'Pager': 'Pager',
    'Home email': 'Kişisel email',
    'Work email': 'İş email',
    'Other email': 'Diğer email',
    'It looks like you are using an outdated version of this script': 'Bu komut dosyasının eski bir sürümünü kullanıyorsunuz gibi görünüyor',
    'You can find the latest one here': 'En güncel olanı burada bulabilirsiniz',
  },
  /* To add a language:
  '[lang-code]': {
